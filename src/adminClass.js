...
Admin.prototype.addNewBook = (noCopies, authorName, bookTitle, bookCategory, bookPages, bookDescription) => {
	return Book.prototype.addNewBook(noCopies, authorName, bookTitle, bookCategory, bookPages, bookDescription);
};
